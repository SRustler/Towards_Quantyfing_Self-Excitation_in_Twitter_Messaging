function h=plplot(x, xmin, alpha, dxmin, dalpha,agree)
...
switch f_dattype,
    ...
    case 'REAL',
        ...
        ylabel('Pr(T \geq \tau)','FontSize',16);
        xlabel('\tau','FontSize',16)
        annotation('textbox', [.2 .2 .1 .1], 'String', ['  \alpha  = ', num2str(alpha),'\pm',num2str(dalpha), char(10),'\tau_{min} = ', num2str(xmin),'\pm',num2str(dxmin)]); %My addition
        legend('Empirical data','Power law fit') %My addition
